...
set "status-left" "#[fg=$onedark_black,bg=#{?session_prefix,$onedark_red,$onedark_green},bold] #S #{prefix_highlight}#[fg=#{?session_prefix,$onedark_red,$onedark_green},bg=$onedark_black,nobold,nounderscore,noitalics]" 
